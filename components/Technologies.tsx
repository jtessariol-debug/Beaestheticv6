...
const Technologies: React.FC<{ technologies: Technology[] }> = ({ technologies }) => {
    return (
        <section id="tecnologia" className="py-20 lg:py-32 bg-brand-beige">
            <div className="container mx-auto px-6">
                <div className="text-center mb-12 fade-up-on-scroll opacity-0">
                    <h2 className="font-serif text-4xl lg:text-5xl text-brand-brown mb-4">Ciencia y Tecnologia de Vanguardia</h2>
                    <p className="font-sans text-brand-gray max-w-2xl mx-auto">Invertimos en las plataformas tecnologicas mas avanzadas y seguras del mundo para ofrecer resultados precisos y superiores.</p>
                </div>
